"""Content-addressable image storage on the filesystem."""
...
class FilesystemImageStore:
    ...
    def get_path(self, content_hash: str, extension: str = ".png") -> Path | None:
        """Resolve content hash to a file path."""
        subdir = content_hash[:2]
