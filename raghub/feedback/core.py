...
class NullTelemetry:
    ...
    def info(self, *_args: Any, **_kwargs: Any) -> None:
        """No-op info log; arguments are dropped silently."""
        ...

    def warning(self, *_args: Any, **_kwargs: Any) -> None:
        """No-op warning log; arguments are dropped silently."""
        ...

    def error(self, *_args: Any, **_kwargs: Any) -> None:
        """No-op error log; arguments are dropped silently."""
        ...

    def record_latency(self, *_args: Any, **_kwargs: Any) -> None:
        """No-op latency recorder; arguments are dropped silently."""
        ...

    def increment(self, *_args: Any, **_kwargs: Any) -> None:
        """No-op counter; arguments are dropped silently."""
        ...

    def start_span(self, *_args: Any, **_kwargs: Any) -> Any:
        """No-op span starter returning ``None``."""
        ...

    def end_span(self, *_args: Any, **_kwargs: Any) -> None:
        """No-op span ender; arguments are dropped silently."""
        ...

    def record_tokens(self, *_args: Any, **_kwargs: Any) -> None:
        """No-op token recorder; arguments are dropped silently."""
        ...
...
class Bm25BoostScorer(FeedbackScorer):
    ...
    * Negative feedback for ``chunk_id``: multiply by
    ...
    def boost(self, chunk_id: str, base_score: float) -> float:
        """Boost synchronously using the in-memory cache.
