...
This module defines the polymorphic :class:`Store` base, the
...
class Store(Registry):
    """Polymorphic base for every vector-store adapter.

    Concrete backends (MemoryStore, SqliteStore, PgVectorStore)
    register themselves via ``@Store.register``.
    """
