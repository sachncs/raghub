...
describe('workspaceRoutes', () => {
  it('lists members', async () => {
    ...
    const app = workspaceRoutes({ pool: undefined as never, memberStore, audit: null, embedder: undefined as never, vectorStore: null });
...
describe('documentAclRoutes', () => {
  it('admin can grant, owner can list', async () => {
    ...
    const app = documentAclRoutes({ principalStore, memberStore, documentStore, audit: null, pool: undefined as never, embedder: undefined as never, vectorStore: null });
