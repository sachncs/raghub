...
from dynamic_rag.models import ChunkRecord
...
class _RealZvecBackend(BaseVectorStore):
    ...
    def delete_document(self, document_id: str) -> None:
        self.collection.delete_by_filter(filter=f"document_id = '{document_id}'")

    def delete_version(self, document_id: str, version: int) -> None:
        self.collection.delete_by_filter(filter=f"document_id = '{document_id}' AND version = {version}")
