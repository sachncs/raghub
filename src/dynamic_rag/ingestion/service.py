...
from dynamic_rag.documents.chunker import ChunkingPlan, build_chunk_records
from dynamic_rag.documents.lifecycle import DocumentLifecycleManager
from dynamic_rag.documents.validation import validate_pdf_upload
from dynamic_rag.documents.versioning import new_version
from dynamic_rag.embeddings.base import BaseEmbeddingProvider
from dynamic_rag.exceptions import DocumentError
from dynamic_rag.models import Classification, DocumentLifecycleStatus, DocumentVersion, UserPrincipal
...
class DocumentIngestionService:
    ...
    def ingest(
        ...
        *,
        ...
        validate_pdf_upload(file_name, pdf_bytes, self.max_upload_bytes)
        self.virus_scan_hook(pdf_bytes)
